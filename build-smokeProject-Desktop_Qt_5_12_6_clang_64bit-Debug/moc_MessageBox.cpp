/****************************************************************************
** Meta object code from reading C++ file 'MessageBox.hh'
**
...
#include "../smokeProject/MessageBox.hh"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'MessageBox.hh' doesn't include <QObject>."
...
QT_MOC_LITERAL(1, 11, 7), // "rejouer"
QT_MOC_LITERAL(2, 19, 0), // ""
QT_MOC_LITERAL(3, 20, 7), // "quitter"
QT_MOC_LITERAL(4, 28, 14), // "rejouerClicked"
QT_MOC_LITERAL(5, 43, 14) // "quitterClicked"

    },
    "MessageBox\0rejouer\0\0quitter\0rejouerClicked\0"
    "quitterClicked"
};
...
void MessageBox::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->rejouer(); break;
        case 1: _t->quitter(); break;
        case 2: _t->rejouerClicked(); break;
        case 3: _t->quitterClicked(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MessageBox::rejouer)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (MessageBox::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MessageBox::quitter)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void MessageBox::rejouer()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void MessageBox::quitter()
{
